...
def write_birthday_inside_circle(text_color, x, y):
    ...
    my_turtle_cursor.getscreen().update()
def write_tome_inside_circle(text_color, x, y):
    my_turtle_cursor.penup()
    # Changing color of our cursor
    my_turtle_cursor.color(text_color)
...
my_turtle_screen.bgcolor("#FFFACD")

# # Creating an empty list of different parts of our cake
parts_of_cake = []
parts_of_cake.append(["#FF69B4", "#000000", 3, 30])
parts_of_cake.append(["#FFB5C5", "#000000", 3, 20])
parts_of_cake.append(["#FFC0CB", "#000000", 3, 60])

# drawing an plate for our cake using draw_layer_of_the_cake() function
draw_layer_of_the_cake("#8B475D", "#000000", 3, -220, y_coordinate - 70, 400, 10)
...
write_happy_inside_circle("#000000", -50, y_coordinate + 250)
# write_birthday_inside_circle("#000000", -80, y_coordinate + 190)

# Writing "Birthday" inside of our circle
write_birthday_inside_circle("#000000", -70, y_coordinate + 210)
write_tome_inside_circle("#000000", -50, y_coordinate + 170)
# wait(100000)
time.sleep(6)
